package com.cw.codewarsplugin.config;
...
public class StringConstants {
    ...
    public static final String JS_MODULE_NOT_FOUND = "Web/JavaScript module not found in the current project! To setup Kata in JS/TS start a new JS/Web project or create a JS module in the current project! JS/TS are supported only in WebStorm and Intellij Ultimate.";
