...
import static com.cw.codewarsplugin.services.files.create.JavascriptFileService.getImportMessage;
...
public class TypescriptFileService extends AbstractFileService{
    ...
    public void initDirectory() {
        ...
        try {
            VirtualFile file = directory.createChildData(this, StringConstants.TS_CONFIG);
